<template>
  <page>
    <template slot="title">
      <h1>Cryptocurrency: What is its Market Value?</h1>
    </template>
    <div>
      <p>
      ...
      <img src="/v2/images/hero.png"
           alt="Current Cryptocurrency Values" />
    </div>
  </page>
</template>
...
export default {
  ...
  computed: {
    title() {
      return "Current List of Cryptocurrency by Market Value";
    },

    description() {
      return "Current List of Cryptocurrency by Market Value can suggest which is deserving to invest in. Take a look a valuable the ICO and decide which one you want to invest.";
    },
    ...
    keywords() {
      return "Currency Cryptocurrency Values,Cryptocurrency Value Chart,Cryptocurrency Market Value,Currency List by Value";
    },
