  ...
  <page>
    ...
    <div>
      <img src="/v2/images/hero.png"
           alt="List of New Cryptocurrencies by Market Cap" />
      <h4>List of New Cryptocurrencies by Market Cap</h4>
      <br />
      <br />
...
export default {
  ...
  computed: {
    title() {
      return "List of Top New Cryptocurrencies by Market Cap";
    },

    description() {
      return "List of Top New Cryptocurrencies by Market Cap can easily give you an idea on which ones are promising. You can easily identify which one are scams.";
    },
    ...
    keywords() {
      return "Top Cryptocurrency List,List of New Cryptocurrencies,List of Cryptocurrencies by Marketcap,Crypto Market Cap";
    },
